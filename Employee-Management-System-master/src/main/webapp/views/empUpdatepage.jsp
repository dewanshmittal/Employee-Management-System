        ...
        <section class="module">
            <div class="module-inner">
                ...
                <div class="content-panel">
                    ...
                    <form class="form-horizontal" action="/updateEmp">
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value=${eid } name= "eid" >
                                </div>
                            </div>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value=${email } name ="empemail" >
                                    <p class="help-block">This is the email </p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label" >Task</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value=${task } name="task">
                                    <p class="help-block">Your task token</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label" >Position</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value=${position } name="position" >
                                    <p class="help-block">eg. Jr.developer</p>
                                </div>
                            </div>
                        </fieldset>
                        <hr>
